    ...
    static void create() throws IOException{
        ...
        switch (pilihan) {
            case 1 -> {
                ...
                int HargaBuku =  Integer.parseInt(br.readLine());
                ...
                Fiksi fks = new Fiksi(Judul, NamaPenerbit, NamaPenulis, HargaBuku, Jenis, Genre, UmurPembaca, Bahasa, "Fiksi");
            ...
            case 2 -> {
                ...
                System.out.println("Masukkan Harga Buku :Rp. ");
                int HargaBuku1 =  Integer.parseInt(br.readLine());
                System.out.println("Masukkan Subject Buku : ");
                String Subject1 = br.readLine();
                System.out.println("Masukkan Bahasa Buku : ");
                String Bahasa1 = br.readLine();
                
                NonFiksi nfks = new NonFiksi(Judul1, NamaPenerbit1, NamaPenulis1, HargaBuku1, Subject1, Bahasa1, "NonFiksi");
            ...
            switch (pilihan) {
                case 1 -> {
                    ...
                    for(int i = 0; i < Fiksi.size(); i++){
                        ...
                        System.out.println("Jenis Buku        :" + Fiksi.get(i).getJenis()+ "\t");
                ...
                case 2 -> {
                    ...
                    for(int i = 0; i < NonFiksi.size(); i++){
                        ...
                        System.out.println("Kategori Buku   :" + NonFiksi.get(i).getKategori()+ "\t");
        ...
        switch (pilihan) {
            case 1 -> {
                ...
                if(index <= Fiksi.size() || index > 0){
                    ...
                    System.out.println("Masukkan Harga Buku :Rp. ");
                    Fiksi.get(index).setHargaBuku(Integer.parseInt(br.readLine()));
                    System.out.println("Masukkan JEnis Buku : ");
                    Fiksi.get(index).setJenis(br.readLine());
                    System.out.println("Masukkan Genre Buku : ");
            ...
            case 2 -> {
                ...
                if(index1 <= NonFiksi.size() || index1 > 0){
                    ...
                    System.out.println("Masukkan Harga Buku :Rp. ");
                    NonFiksi.get(index1).setHargaBuku(Integer.parseInt(br.readLine()));
                    System.out.println("Masukkan Subject Buku : ");
